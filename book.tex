...
\fancyhead[LO]{}
\fancyhead[RO]{
{\sffamily\small \leftmark}
\begin{picture}(0,0)(-3,0)
 \linethickness{12pt}
 \put(15,3.5){\line(1,0){80}}
 \linethickness{0pt}
 \put(15,3.5){\framebox(20,0){\textcolor{white}{\small \sffamily \thepage}}}
\end{picture}
}
\fancyhead[LE]{
\begin{picture}(0,0)(3,0)
 ...
 \linethickness{0pt}
 \put(-35,3.5){\framebox(20,0){\textcolor{white}{\small \sffamily \thepage}}}
\end{picture}
}
\fancyhead[RE]{}
\fancyfoot{}
...
\hskip-0.03\textwidth\includegraphics[width=1.06\textwidth,height=7.59mm]{images/chapter-title-ornament.eps}\vskip-7.59mm\vskip-0.5\Cvs
    \end{center}
    \par\nobreak
